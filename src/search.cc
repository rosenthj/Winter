...
EXPR NScore kSNMPScaling = 669;
EXPR NScore kSNMPOffset = -74;
EXPR NScore kSNMPImproving = 195;
EXPR NScore kFutilityScaling = 715;
EXPR NScore kFutilityOffset = 135;
EXPR NScore kFutilityImproving = 148;
