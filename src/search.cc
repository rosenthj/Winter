...
EXPR NScore kSNMPScaling = 696;
EXPR NScore kSNMPOffset = -117;
EXPR NScore kSNMPImproving = 160;
EXPR NScore kFutilityScaling = 700;
EXPR NScore kFutilityOffset = 143;
EXPR NScore kFutilityImproving = 147;
