...
//   search::SetArmageddon(armageddon_setting);
  ...
  {"LMROffset", search::SetLMROffset, 91, 0, 100},
  {"LMRMultiplier", search::SetLMRMultiplier, 82, 0, 250},
  {"LMROffsetCap", search::SetLMROffsetCap, -6, -100, 0},
  {"LMRMultiplierCap", search::SetLMRMultiplierCap, 28, 0, 100},
  {"LMROffsetPV", search::SetLMROffsetPV, -47, -100, 0},
  {"LMRMultiplierPV", search::SetLMRMultiplierPV, 79, 0, 100},
