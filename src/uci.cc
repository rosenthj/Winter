...
const std::vector<UCIOption> uci_options {
  ...
  {"SNMPScaling", search::SetSNMPScaling, 574, 0, 1500},
  {"SNMPOffset", search::SetSNMPOffset, 0, -1500, 1500},
  {"SNMPImproving", search::SetSNMPImproving, 100, 0, 1500},
  {"FutilityScaling", search::SetFutilityScaling, 553, 0, 1500},
  {"FutilityOffset", search::SetFutilityOffset, 0, -1500, 1500},
  {"FutilityImproving", search::SetFutilityImproving, 60, 0, 1500},
  {"SingularDepth", search::SetSingularExtensionDepth, 9, 4, 20},
  {"LMROffset", search::SetLMROffset, -2, -55, 100},
  {"LMRMultiplier", search::SetLMRMultiplier, 82, 0, 250},
  {"LMROffsetCap", search::SetLMROffsetCap, 23, -55, 100},
  {"LMRMultiplierCap", search::SetLMRMultiplierCap, 64, 0, 100},
  {"LMROffsetPV", search::SetLMROffsetPV, 36, -55, 100},
  {"LMRMultiplierPV", search::SetLMRMultiplierPV, 82, 0, 100},
  {"LMROffsetPVCap", search::SetLMROffsetPVCap, 27, -155, 100},
//  {"LMRMultiplierPVCap", search::SetLMRMultiplierPVCap, 23, 0, 100},
  ...
  {"LMPQuadratic", search::SetLMPQuadratic, 5, 0, 16},
#endif
};
